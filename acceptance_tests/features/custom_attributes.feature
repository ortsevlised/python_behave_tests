Feature: Custom attributes can be added, edited and deleted
  ...
  Scenario: Going to custom attributes menu
...
##  Scenario: Attributes added from settings are available in a conversation
##  Scenario: Attributes added from a conversation are available in settings
#
#
